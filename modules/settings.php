    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200">
        ...
        <div class="p-8">
            ...
            <div id="settingsTabLicense" class="settings-tab-panel" style="display:none;">
                ...
                ?>
                <div class="rounded-xl border-2 p-5 mb-6 <?= $licValid ? 'bg-emerald-50 border-emerald-200' : 'bg-red-50 border-red-200' ?>">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="ml-auto">
                            <form method="POST">
                                ...
                                <button type="submit" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-white hover:bg-slate-50 border border-slate-300 transition-colors shadow-sm">
                    ...
                    <?php if($licExp !== ''): ?>
                        <p class="text-xs mt-2 ml-6 <?= $licValid ? 'text-emerald-600' : 'text-red-600' ?>">Expires: <?= e($licExp) ?></p>
                    <?php endif; ?>
                </div>

                <!-- Current License Key -->
                <div class="mb-6">
                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Current License Key</label>
                    <div class="px-4 py-3 bg-slate-50 border border-slate-200 rounded-lg font-mono text-sm text-slate-700">
                        <?= $licenseMasked !== '' ? e($licenseMasked) : '<span class="text-slate-400 italic">No key configured</span>' ?>
                    </div>
                </div>

                <!-- Update License Key -->
                <div>
                    <label class="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Update License Key</label>
                    <form method="POST">
                        <input type="hidden" name="csrf" value="<?= csrf_token() ?>">
                        ...
                        <div class="flex gap-3">
                            <input
                                ...
                                class="flex-1 px-4 py-2.5 bg-white border border-slate-300 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all font-mono text-sm"
                        ...
                        <p class="text-xs text-slate-400 mt-2">Enter your PharmaCore license key to activate the product.</p>
                    </form>
                </div>
            </div>
            <!-- ── /License Tab Panel ────────────────────────────────────── -->
